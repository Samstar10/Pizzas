...
Revision ID: c9caa6fd6f96
Revises: d84f065c03c2
Create Date: 2024-01-19 12:50:48.084187
...
revision = 'c9caa6fd6f96'
down_revision = 'd84f065c03c2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('heroes_id_seq'::regclass)"), autoincrement=True, nullable=False),
